...
Animation = function () {
    ...
    var o = [], u = 1, a = .1, f = 2, l = "ht" + "tp://ho" + "vertree.c" + "om/hvti" + "mg/201512/ph2aerfy.p" + "ng", c = [], h = 5, p = 20, d = 20, v = {}, m = 1, g = 4, y = -1, b = 3, w = .2, E = 1.25, S = 2, x = 3, T = .2, N = .9, C = 50, k = 60, L = 0, A = 1, O = .1, M = 1.5, _ = .05, D, P, H, B, j, F, I;
    return {init: s}
